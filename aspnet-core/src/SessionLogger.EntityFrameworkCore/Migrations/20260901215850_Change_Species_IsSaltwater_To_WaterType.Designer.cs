...
namespace SessionLogger.Migrations
{
    ...
    [Migration("20260901215850_Change_Species_IsSaltwater_To_WaterType")]
    partial class ChangeSpeciesIsSaltwaterToWaterType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SessionLogger.Domain.Baits.Bait", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SessionLogger.Domain.Methods.Method", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppMethod", (string)null);
                });

            modelBuilder.Entity("SessionLogger.Domain.Rigs.Rig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal?>("HookWeightG")
                        .HasPrecision(8, 2)
                        .HasColumnType("decimal(8,2)");

                    b.Property<int?>("HookWeightUnit")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SessionLogger.Domain.SpeciesTypes.Species", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SessionLogger.Domain.Tickets.Ticket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppTicket", (string)null);
                });

            modelBuilder.Entity("SessionLogger.Domain.UserPreferences.UserPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("PersonalBestMetric")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
                    ...
                    b.ToTable("AppUserPreference", (string)null);
                });
            ...
            modelBuilder.Entity("SessionLogger.Domain.Venues.Venue", b =>
                {
                    ...
                    b.ToTable("AppVenue", (string)null);
                });
            ...
            modelBuilder.Entity("SessionLogger.Domain.Catches.Catch", b =>
                {
                    ...
                    b.HasOne("SessionLogger.Domain.Methods.Method", "Method")
                        .WithMany()
                        .HasForeignKey("MethodId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("SessionLogger.Domain.Rigs.Rig", "Rig")
                        .WithMany()
                        .HasForeignKey("RigId")
                        .OnDelete(DeleteBehavior.Restrict);
